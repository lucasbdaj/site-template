    ...
    <footer style={{ background: "#111827", color: "white" }}>
      <div style={{
        ...
        <div style={{
          ...
          {/* Redes sociais */}
          {(config.instagram || config.facebook || config.linkedin || config.site) && (
            <div>
              <p style={{ fontSize: 13, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "#6b7280", marginBottom: 16 }}>
                Redes sociais
              </p>
              {config.instagram && (
                <a href={config.instagram} target="_blank" rel="noopener noreferrer"
                  style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: "#9ca3af", textDecoration: "none", marginBottom: 12 }}>
              ...
              {config.site && (
                <a href={config.site} target="_blank" rel="noopener noreferrer"
                  style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: "#9ca3af", textDecoration: "none" }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/>
                  </svg>
                  {config.site.replace(/https?:\/\/(www\.)?/, "").replace(/\/$/, "")}
                </a>
              )}
            </div>
          )}
