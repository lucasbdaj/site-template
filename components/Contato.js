                ...
                {horariosEstruturados ? (
                  config.horario.map((h, i) => (
                    <div key={i} style={{
                      ...
                      <span style={{ fontSize: 13, opacity: 0.85 }}>{h.dia}</span>
                      <span style={{
                        fontSize: 13,
                        fontWeight: 600,
                        color: h.horario === "Fechado" ? "rgba(255,255,255,0.4)" : "white",
                      }}>{h.horario}</span>
                    </div>
                  ))
                ) : (
                  config.horario.map((h, i) => (
                    <p key={i} style={{ fontSize: 13, opacity: 0.85, marginBottom: 6 }}>{h}</p>
                  ))
                )}
              </div>
            )}
